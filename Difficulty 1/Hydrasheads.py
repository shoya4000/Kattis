...
# Knight PyPy wants to kill Hydra as soon as possible, so that he can save
# Princess Perly. What is the minimum number of moves that PyPy needs to
# use to kill Hydra?
...
# Thus PyPy can kill Hydra with 9 moves. This is also the minimum number
# of moves for this test case.
